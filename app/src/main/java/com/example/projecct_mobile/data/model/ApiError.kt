...
sealed class ApiException(
    ...
    /**
     * Exception pour les erreurs de quota Gemini API (429)
     * @param message Message d'erreur
     * @param retryAfterSeconds Nombre de secondes avant de pouvoir réessayer (optionnel)
     */
    class GeminiQuotaException(
        message: String = "Quota API Gemini dépassé. Veuillez réessayer plus tard.",
